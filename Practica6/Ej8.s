...
color_pelota2:   .word32 0x0000FF00  ; Rojo
color_pelota3:   .word32 0x000000FF  ; Verde
color_pelota4:   .word32 0x00FFFF00  ; Amarillo
color_pelota5:   .word32 0x00FF00FF  ; Magenta
...
loop:           daddi $a2, $0, 1    ;Pelota 1 (Pelota 1 tiene numero 1)
                ...
                daddi $t0, $0, 999   ; Hace una demora para que el rebote no sea tan rápido.
...
resta:          daddi $t0, $t0, -40
                ...
                sd  $s0, 24($t0)             ; Guardo dirección Y de la pelota
               ...
               #define nPares(x,y) (x%2)&&(y%2) ? 2 :(x%2)||(y%2) ? 1: 0